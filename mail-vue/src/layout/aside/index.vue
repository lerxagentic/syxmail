  ...
  <el-scrollbar class="scroll">
    <div>
      ...
      <el-menu :collapse="false" text-color="#fff" active-text-color="#fff" style="margin-top: 10px">
        ...
        <div class="manage-title" v-perm="['all-email:query','user:query','role:query','setting:query','analysis:query','reg-key:query','api-key:query','api-key:admin']">
          <div>{{$t('manage')}}</div>
        </div>
        ...
        <el-menu-item @click="router.push({name: 'api-key-manage'})" index="api-key-manage" v-perm="['api-key:query', 'api-key:admin']"
                      :class="route.meta.name === 'api-key-manage' ? 'choose-item' : ''">
          <Icon icon="fluent:key-20-regular" width="22" height="22" />
          <span class="menu-name" style="margin-left: 20px">{{$t('apiKeyManage')}}</span>
        </el-menu-item>
        <el-menu-item @click="router.push({name: 'domain'})" index="domain" v-perm="'setting:query'"
                      :class="route.meta.name === 'domain' ? 'choose-item' : ''">
          <Icon icon="fluent:globe-20-regular" width="20" height="20" />
          <span class="menu-name" style="margin-left: 21px">{{$t('manageDomain')}}</span>
        </el-menu-item>
