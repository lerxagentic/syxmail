const en = {
    ...
    emailRetentionDesc: 'Configure how long emails are retained before automatic deletion. Supports per-domain and per-user overrides.',
    retentionDays: 'Global Retention (Days)',
    domainRetentionRules: 'Domain Overrides',
    userRetentionRules: 'User Overrides',
    retentionDaysPlaceholder: 'e.g. 7',
    userOrEmail: 'User Email or ID',
    userOrEmailPlaceholder: 'e.g. admin@lerxagentic.tech',
    domainSelectPlaceholder: 'Select or enter domain',
    addRule: 'Add Rule',
    noRules: 'No rules set. Default global retention will apply.',
    days: 'Days',
    daysUnit: 'd',
    ...
    emailRoutingStatus: 'Email Routing',
    autoSetup: 'Auto Setup',
    configStep: 'Configuration Steps',
    step1: 'Add domain to Cloudflare',
    step2: 'Configure Nameservers',
    step3: 'Enable Email Routing',
    step4: 'Add Catch-all Worker',
    verify: 'Verify',
    deleteDomainConfirm: 'Are you sure you want to delete this domain?',
    addDomainSuccess: 'Domain added successfully',
    verifySuccess: 'Domain status verified',
    domainPlaceholder: 'example.com',
    inactive: 'Inactive',
    deleteSuccess: 'Deleted successfully',
    apiKeyManage: 'API Key Manage',
    createApiKey: 'Create API Key',
    'perms.API Key': 'API Key',
    'perms.View API Key': 'View API Key',
    'perms.Create API Key': 'Create API Key',
    'perms.Delete API Key': 'Delete API Key',
    'perms.Manage All User API Keys': 'Manage All User API Keys'
}
