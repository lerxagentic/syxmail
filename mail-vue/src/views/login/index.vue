      ...
      <div class="container">
        ...
        <div v-show="show !== 'login'">
          <el-input :class="!hideLoginDomain ? 'email-input' : ''" v-model="registerForm.email" type="text" :placeholder="$t('emailAccount')"
                    autocomplete="off">
            <template #prefix>
              <Icon @click.stop="genRandomRegisterEmail" class="gen-code" icon="bitcoin-icons:refresh-filled" width="20" height="20" :title="$t('random')"/>
            </template>
            <template #append v-if="!hideLoginDomain">
              <div @click.stop="openSelect">
                <el-select
    ...
    <el-dialog class="bind-dialog" v-model="showBindForm"  title="注册邮箱" >
      <div class="bind-container">
        <el-input :class="!hideLoginDomain ? 'email-input' : ''" v-model="bindForm.email" type="text" :placeholder="$t('emailAccount')" autocomplete="off">
          <template #prefix>
            <Icon @click.stop="genRandomBindEmail" class="gen-code" icon="bitcoin-icons:refresh-filled" width="20" height="20" :title="$t('random')"/>
          </template>
          <template #append v-if="!hideLoginDomain">
            <div @click.stop="openSelect">
              <el-select
...
function genRandomRegisterEmail() {
  registerForm.email = generateRandomUsername(settingStore.settings.minEmailPrefix);
}

function genRandomBindEmail() {
  bindForm.email = generateRandomUsername(settingStore.settings.minEmailPrefix);
}
